...
namespace BTL_LWNC_WebAmNhac.Controllers
{
    public class GenresController : Controller
    {
        ...
        public GenresController(BTL_LWNC_WebAmNhacContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genre != null ? 
                          ...
                          Problem("Entity set 'BTL_LWNC_WebAmNhacContext.Genre'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BTL_LWNC_WebAmNhacContext.Genre'  is null.");
            }
            var genre = await _context.Genre.FindAsync(id);
            if (genre != null)
            {
