...
namespace BTL_LWNC_WebAmNhac.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Detail,Thumbnail,UserID")] Playlist playlist)
        {
            ...
            ViewData["UserID"] = new SelectList(_context.Set<User>(), "ID", "Name", playlist.UserID);
            return View(playlist);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Detail,Thumbnail,UserID")] Playlist playlist)
        {
            if (id != playlist.ID)
            {
                return NotFound();
